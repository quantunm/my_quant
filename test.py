...
if __name__ == '__main__':
    ...
    #rsrs.run_test(df_benchmark, 20000, 0.0003, 0.001, 0.01, 0.7, -0.7, 
    #    '20100104', '20171204',df_FCR, df_BCR, df_NCR, 18, 600)
    
    #rsrs.run_test(df_benchmark, 20000, 0.0, 0.0, 0.0, 0.7, -0.7, 
    #    '20150105', '20200914',df_FCR, df_BCR, df_NCR, 18, 600)

    rsrs.run_test(df_benchmark, 2000000, 0.0003, 0.001, 0.01, 0.7, -0.7, 
        '20100104', '20171204',df_benchmark, df_benchmark, df_benchmark, 18, 600)
